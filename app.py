...
<div class='card'><p class='muted'>Live universe: 207 workbook stocks minus LTIM. Day-start report: 09:15 IST. EOD report: 15:40 IST. Rules: 09:30–15:20 IST, VWAP/day high or low confirmation, OI change below -4%, spread below 1.5, volume above 1.5× average, and alerts for every qualifying stock. Duplicate unchanged setups are suppressed while active. This tool generates alerts only and does not place orders.</p><p class='muted'>Last cycle: <span id='cycle'>-</span></p></div>
